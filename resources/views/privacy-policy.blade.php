	...
	<div class="container">
		<div class="row section-padding-80">
			<div class="col-md-12">
				...
				<p>Effective date: July 10, 2019</p>
				<p>sella ("us", "we", or "our") operates the https://getsella.com website (the "Service").</p>

				<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for sella is created with the help of the <a href="https://freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy Generator</a>.</p>
				...
				<p>sella uses the collected data for various purposes:</p>    
				<ul>
				...
				<p>sella will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

				<h2>Disclosure Of Data</h2>

				<h3>Legal Requirements</h3>
				<p>sella may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
				<ul>
				    <li>To comply with a legal obligation</li>
				    <li>To protect and defend the rights or property of sella</li>
				...
				<ul>
				        <li>By email: info@sella.ng</li>
				            <li>By visiting this page on our website: https://getsella.com/contact</li>
